                  ...
                  <div class="form cf" id="tabs-1-1">
                    <ul class="d-flex flex-wrap p-0 pt-2 plan cf">
                        ...
                        <div class="hovereffect rounded img-thumbnail">
                          <img class="img-responsive" src="http://placehold.it/200x200" alt="">
                              <label class="skin1 overlay" for="skin1">
                                 <h2>skin1</h2>
                                 <input class="skin-btn" type="radio" name="skin" id="skin1" value="skin1" ${content.skin == 'skin1' ? 'checked' : ""}>
                      ...
                      <li class="col-6 p-2">
                        <div class="hovereffect rounded img-thumbnail">
                          <img class="img-responsive" src="http://placehold.it/200x200" alt="">
                              <label class="skin9 overlay" for="skin9">
                                 <h2>skin9</h2>
                                 <input class="skin-btn" type="radio" name="skin" id="skin9" value="skin9" ${content.skin == 'skin9' ? 'checked' : ""}>
                                 <label class="premium-label four col info" for="skin9"><p class="info" href="#" >적용하기</p></label>
                              </label>
                        </div>
                      </li>                      
                    </ul>
                ...
                <div class="sub-tab-section border p-3 mb-5">
                  ...
                  <div id="tabs-2-0">
                    <div class="tabs-2-0-topTitle px-2 pb-3 border">
                      <h3 class="section-title formTopTitle">초대장 제목</h3>
                    ...
                    <div class="tabs-2-0-topImg px-2 pb-3 border">
                      ...
                      <div class="section-content">
                        ...
                        <div class="top-img-preview-wrap">
                        	<img src="../img/content/content_img/${content.topImgFile}" class="top-img-preview" alt="상단 이미지 미리보기" height="150">
                ...
                <div class="sub-tab-section border p-3 mb-5">
                  ...
                  <div id="tabs-3-1">
                    <div class="tabs-3-1-infoDateStart px-2 pb-3 border">
                      <h3 class="section-title formInfoDate">발표회 일자</h3>
                      <div class="section-content">
                        <!-- 행사 시작 날짜 -->
                    ...
                    <div class="tabs-3-1-infoTime px-2 pb-3 border">
                      <h3 class="section-title formInfoTime">발표회 시간</h3>
                      <div class="section-content">
                        <!-- 행사 시간 -->
                    ...
                    <div class="tabs-3-1-infoPlace px-2 pb-3 border">
                      <h3 class="section-title formInfoPlace">발표회 장소</h3>
                      <div class="section-content">
                        <!-- 행사 장소 -->
                  ...
                  <div id="tabs-3-2">
                    <div class="tabs-3-2-addInfoWelcome px-2 pb-3 border">
                      <h3 class="section-title formAddInfoWelcome">인사말</h3>
                      <div class="section-content">
                        <!-- 인사말 -->
                    ...
                    <div class="tabs-3-2-addInfoImgProfile px-2 pb-3 border formAddInfoImgProfileBox">
                      <h3 class="section-title formAddInfoImgProfile">발표자(팀) 프로필 입력</h3>
                      <div class="section-content">
                        <!-- 발표자(팀) 프로필 입력 -->
                        ...
                        <div class="add-info-img-profile-preview-wrap">
                        	<c:if test="${content.addInfoImgProfile ne ''}">
                        		<img src="../img/content/content_img/${content.addInfoImgProfile}" class="add-info-img-profile-preview" height="150">
                        	</c:if>
                        	<c:if test="${content.addInfoImgProfile eq ''}">
                        		<img class="add-info-img-profile-preview" height="150">
                        	</c:if>
                        </div>
                      </div>
                    </div>
                    <div class="tabs-3-2-addInfoImgSit px-2 pb-3 border formAddInfoImgSitBox">
                      <h3 class="section-title formAddInfoImgSit">자리 배치도 이미지</h3>
                      <div class="section-content">
                        <!-- 자리 배치도 이미지 첨부 -->
                        <div class="custom-file mt-1">
                    ...
                    <div class="tabs-3-2-addInfoCall px-2 pb-3 border">
                      <h3 class="section-title formAddInfoCall">문의 정보</h3>
                      <div class="section-content">
                        <!-- 문의 정보 입력 -->
                        <div class="form-row">
                          <div class="col">
                  ...
                  <div id="tabs-3-3">
                    <div class="tabs-3-3-infoLoc px-2 pb-3 border">
                      <h3 class="section-title formInfoAddress">발표회 장소 주소</h3>
                      <div class="section-content d-flex flex-column">
                        <div class="input-group mb-3">
                          <input id="info-address-text" type="text" class="form-control infoAddress" placeholder="장소 주소" name="info-address" value="${content.infoAddress == '' ? '' : content.infoAddress}">
                      ...
                      <div class="d-flex justify-content-between align-items-center">
						...
						<a class="tooltips">
		                        <input class="onoff-box infoLoadImgchk ml-2" type="checkbox" id="toggle11" checked="checked" name="info-load-img-chk" value="${content.infoLoadImgChk}"
									onclick="chkFuc('info-load-img-chk', 'info-load-section')" ${content.infoLoadImgChk == 1 ? 'checked' : ""}>
                  ...
                  <div id="tabs-5-0">
                    ...
                    <div class="account-chk-div">
                        ...
                        <div class="section-content">
                          <div class="input-group mb-3">
                            ...
                            <select class="custom-select" id="inputGroupSelect01" name="account-select" class="accountSelect">
                              ...
                              <c:if test="${user.userAccount ne ''}"> <!-- user의 계좌번호 있으면 -->
                      ...
                      <div class="tabs-5-0-money px-2 pb-3 border">
                        <h3 class="section-title formAccountMoney">관람료</h3>
                        <div class="section-content">
...
<!--   <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-jcrop/2.0.4/js/Jcrop.min.js"></script> -->
  ...
  <!-- map js -->
  <script type="text/javascript" src="https://openapi.map.naver.com/openapi/v3/maps.js?clientId=MJsGHyHKOMqRFAFzWWEr&submodules=geocoder&callback=CALLBACK_FUNCTION"></script>
